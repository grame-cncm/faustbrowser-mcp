...
// - Renders the analysis panel (scope/spectrum/probes) from runtime metrics.
// - Drives the DSP diagram panel (SVG fetch + navigation history).
// - Updates the MIDI panel and polyphonic activity status.
