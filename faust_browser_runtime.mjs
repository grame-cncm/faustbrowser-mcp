 ...
 * - Expose tool methods used by the MCP browser server (mostly RT-compatible).
 * - Provide UI-only helpers (unlock_audio, get_svg_diagrams), scope/spectrum
 *   metrics, and MIDI input handling.
 */
import {
